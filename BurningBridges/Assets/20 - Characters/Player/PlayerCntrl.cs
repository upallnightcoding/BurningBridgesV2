...
public class PlayerCntrl : MonoBehaviour
{
     ...
     * AssistedAiming() - 
     */
    private Vector3 AssistedAiming()
    {
        Vector3 aimDirection = transform.forward;

        enemies = Physics.OverlapSphere(transform.position, 8.0f, enemyLayerMask);

        Transform bestTarget = null;
        float bestAngle = 30.0f;
        ...
        return (bestTarget != null ? bestDir : transform.forward);
    }
